	...
	<!--<![endif]-->
					...
					<ul class="nav pull-right">
						<li id="fat-menu" class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a tabindex="-1" href="?page=setting">Settings</a></li>
								<li class="divider"></li>
								<li><a tabindex="-1" href="?page=logout" onclick="return confirm('Apakah Anda yakin akan keluar?')">logoutguru</a></li>
							</ul>
						</li>
						
					</ul>
				</div>
					<a class="brand" href="#"><span class= first>UJIAN BIOLOGI </span> 
			</div>
		</div>
		...
		<div class="sidebar-nav">
			...
			<ul id="murid-menu" class="nav nav-list collapse in">
				<li><a href="?page=murid">Daftar Siswa</a></li>
			</ul>
		</div>
